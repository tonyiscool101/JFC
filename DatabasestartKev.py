...
df2 = df.drop_duplicates('Recipient', keep='first')
...
uniqueRecipientList = [n for n in recipientboth if n not in senderboys]
ID_list = senderboys + uniqueRecipientList
print(np.shape(uniqueRecipientList))
print(np.shape(senderboys))
